# No adjustments were made to this file
# See "CSCI-GA.3033-090" at https://cs.nyu.edu/dynamic/courses/schedule/?semester=fall_2020&level=GA
# for description of course which provided code
# Allows for human user to play OpenAI Gym CarRacing-v0 game
# Use --collect_data flag to collect data, to be saved at "./data/data.pkl.gzip"
...
if __name__ == "__main__":
    ...
    while True:
        ...
        state = env.reset()
        while True:
            #print(a) # Uncomment to see print stream of actions at each step
